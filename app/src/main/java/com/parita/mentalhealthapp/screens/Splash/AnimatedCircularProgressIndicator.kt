...
private fun ProgressStatus(
    ...
    Text(modifier = modifier, text = buildAnnotatedString {
        val emphasisSpan = com.parita.mentalhealthapp.ui.theme.Typography.titleLarge
            .copy(color = if (currentValue == maxValue) completedColor else progressIndicatorColor)
                .toSpanStyle()
        val defaultSpan =
            com.parita.mentalhealthapp.ui.theme.Typography.bodyMedium.copy(color = progressBackgroundColor).toSpanStyle()
